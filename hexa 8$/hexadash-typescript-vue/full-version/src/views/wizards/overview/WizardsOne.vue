...
const handleMethodSubmit = (values: any) => {
  console.log(values);
};
      ...
      return {
        ...
        product: (
          <div class="cart-single">
            <FigureWizards>
              <img style={{ width: 80 }} src={`/src/${img}`} alt="" />
              <figcaption>
                                ...
                                <a-form-item name="year">
                                  <a-select :style="{ width: '100%' }">
                                    ...
                                    <a-select-option
                                      ...
                                      :key="value"
                                      :value="parseInt(new Date().getFullYear().toString(), 10) + parseInt(value, 10)"
                                    >
                                      {{ parseInt(new Date().getFullYear().toString(), 10) + parseInt(value, 10) }}
                                    </a-select-option>
                                  </a-select>
                                </a-form-item>
              ...
              <div class="ninjadash-review-order__single">
                <sdCards headless>
                  ...
                  <article class="ninjadash-review-order__shippingInfo">
                    <a-radio-group v-model:value="shippingValue" :style="{ width: '100%' }">
